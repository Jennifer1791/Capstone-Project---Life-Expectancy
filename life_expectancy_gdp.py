...
Chile, China, Germany, Mexico, USA, Zimbawe
...
ax.set_xticklabels(labels=["Chile", "China","Germany","Mexico","USA", "Zimbabwe"],rotation=90)
plt.show()
...
ax1=sns.barplot(data=df,x='Country', y='LEABY')
ax1.set_xticklabels(labels=["Chile", "China","Germany","Mexico","USA", "Zimbabwe"],rotation=90)
plt.show()
...
#There are some simalirities in results. The country with the lowest GDP also has the lowest Life Expectancy (Zimbabwe) and the country highest GDP also has the longest life expectancy rate (USA). However other countries show different results in both aspects. 
...
f, ax2 = plt.subplots(figsize=(10, 15)) 
ax2=sns.barplot(x="Country", y="GDP", hue="Year", data=df)
...
f, ax3 = plt.subplots(figsize=(10, 15)) 
ax3=sns.barplot(x="Country", y="LEABY", hue="Year", data=df)
plt.xticks(rotation=90)
...
# The country that changed the most in terms of life expectancy is Zimbabwe and China in terms of GDP, specially from 2008.
#Each country changed at different rates
#GDP e Life Expectancy seem to have a positive correlation however it is stronger in some countries than others.
...
g = (g.map(sns.scatterplot, "GDP", "LEABY", edgecolor="w").add_legend())
g.fig.subplots_adjust(top=0.9)
g.fig.suptitle('Life Expectancy vs GDP')
plt.savefig("Facetgrid1.png")
...
#The country that moves the most in the X axis is China and in Y axis Zimbabwe
#It isn't suprising
...
g3.fig.suptitle('Life Expectancy by Country')
plt.savefig("Facetgrid2.png")
...
g4 = (g4.map(plt.plot, "Year", "GDP",color="#3e9455").add_legend())
g4.fig.subplots_adjust(top=0.9)
g4.fig.suptitle('GDP by Country')
plt.savefig("Facetgrid3.png")
...
China has reformed and open up its economy in the last decades which provided a steady annual grow in the last decades of about 10%. This changes took millions of people out of poverty and improve heath, education and different services in most recent years.
